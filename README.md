...
- The profile image is a web-ready conversion of the repository's original `avatar.HEIC`; the header and browser-tab icon use a circular, transparency-masked derivative of the supplied `logo.jpeg`.
